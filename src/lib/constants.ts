...
export function sampleItems(): Item[] {
  ...
  return [
    ...
    { id: uid(), name: "Shared loan", kind: "expense", cat: "Debt & financing", amount: 300, freq: "monthly", first: toYM(T - 5), last: toYM(T + 31), reimb: { who: "Partner", amount: 300, freq: "monthly", first: "", last: "", extras: [], overrides: [], paid: [], deferred: [] } },
    { id: uid(), name: "Second phone contract", kind: "expense", cat: "Family", amount: 30, freq: "monthly", first: toYM(T - 3), last: toYM(T + 20), reimb: { who: "Family member", amount: 30, freq: "monthly", first: "", last: "", extras: [], overrides: [], paid: [], deferred: [] } },
